...
propensity_score <- glm(exposure ~ confounder, data=cohort, family=binomial(link="logit"))$fitted.values
...
plot_data <- data.frame(propensity_score,exposure=as.factor(exposure))
