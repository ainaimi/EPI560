...
Causal inference starts with a clear idea of the effect of interest (the target causal parameter, or **estimand**). We use potential outcomes to do this, but it is important first to distinguish between estimands, estimators, and estimates.
