...
"Causal inference" deals primarily with the **formal mechanisms by which we can combine data, assumptions, and models to interpret a correlation (or association) causally**.^[There are a number of introductory books and articles on causal inference in the empirical sciences. Here are some excellent options: @Hernan2015, @Pearl2016, @Imbens2015, @Cunningham2021] The framework in which we define what we mean by "causal relation" or "causal effect" is the **potential outcomes framework**.
...
More considerations for IV estimators: weak instruments, homogeneity.
