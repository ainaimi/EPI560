...
* Six Topics:
   ...
   - Cohorts and Survival: Cohort and Timescale, Censoring and Truncation, Risk Functions, Kaplan-Meier Estimator, Competing Risks.
   
   - Causal Inference: Correlation and Causation; Introduction to Causal Inference; Potential Outcomes; Estimand, Estimator, Estimate; Identifiability.
   
   - Regression Modeling: Standard Regression, Marginal versus Conditional Models, Distributions and Link Functions, Marginal Standardization.
   
   - Time-Varying Data & g Methods: Longitudinal Data, Complex Longitudinal Data, Time Varying Confounding, Inverse Probability Weighting, G Computation, G Estimation of SNMMs.
...
.center[Will Follow Emory and RSPH Guidelines]
...
As we prepare for Spring semester, Emory continues to monitor the COVID-19 situation and we understand things may shift quickly. Currently, Emory is still operating on a [moderate yellow status](https://www.emory.edu/forward/covid-19/operating-condition-status.html). We recommend that all faculty continue to prepare for an online option should the current guidance change. The [CFDE Teaching Toolkit](https://cfde.emory.edu/toolkit/index.html) and RSPH ROTE course are available resources as needed. Please continue to monitor your [emory.edu](https://www.emory.edu/home/index.html) email and the [Emory Forward](https://www.emory.edu/forward/) website over the break for updates.
...
.font150[* My goal: promote a non-judgemental environment in which students comfortably **reveal their** strengths and **limitations**.]
...
.font150[Generally, there are incredible tools at your disposal that can facilitate learning. Some of my favorites:]
