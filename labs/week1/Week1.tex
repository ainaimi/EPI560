...
\item All of the R code for all applied questions must be provided as a separate file (with .R as the extension) along with the homework file.
\item This assignment is due {\bf electronically} to your TA on {\bf ..} at the beginning of class.
\end{itemize}
