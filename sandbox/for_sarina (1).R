...
# check equivalence on OR scale
OR_ATE_hat <- EY1_hat/(1 - EY1_hat) / ( EY0_hat/(1-EY0_hat) )
OR_ATT_hat <- EY1_Ais1_hat/(1 - EY1_Ais1_hat) / ( EY0_Ais1_hat/(1-EY0_Ais1_hat) )

OR_ATE_hat - OR_ATT_hat
